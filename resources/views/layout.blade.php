  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @foreach ($menus as $menu)
          <li class="treeview">
            ...
            @if (count($menu->childs))
              @include('childMenu', ['childs' => $menu->childs])
            @endif
          </li>
        @endforeach
        ...
        {{-- <li class="treeview">
          <a href="">
            <i class="fa {!! $parent->icon !!}"></i> <span>{!! $parent->name !!}</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
            <ul class="treeview-menu">
              <li><a href="{{ url($key->url) }}"><i class="fa {!! $key->icon !!}"></i> {!! $key->name !!}</a></li>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
              {{-- <li><a href="{{ url('{!! $rowMenu->url !!}') }}"><i class="fa {!! $rowMenu->icon !!}"></i> {!! $rowMenu->name !!}</a></li> --}}
              {{-- <li><a href="index2.html"><i class="fa fa-circle-o"></i> Authorization</a></li> --}}
            {{-- </ul> --}}
        </li>
      </ul>
    </section>
